            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ url('admin/update/year') }}" method="POST">
                      @csrf
                      @method('post')
                      <input type="hidden" name="id" value="{{ $data->id }}">
                        ...
                        <div class="form-group" >
                            ...
                            <br>
                            <input type="text" pattern="^(20)\d{2}$" maxlength="4" class="form-control" name="year" value="{{ $data->year }}" id="exampleInputYear" placeholder="Year">
