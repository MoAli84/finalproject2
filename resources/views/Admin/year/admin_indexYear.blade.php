            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card col-md-8 grid-margin">
                <p class="card-description" style="margin: 20px;">
                    <a href="{{ url('admin/create/year') }}" > <button type="button" class="btn btn-primary"> Add Year</button></a>
                  </p>
                          ...
                          @foreach ($data as $y)
                             <td>{{ $y->id }} </td>
                              ...
                              <td>
                                  ...
                                  <a href="{{ url('admin/edit/year/'. $y->id ) }}"> <button type="button" class="btn btn-primary"  style="margin-right: 10px;"> Edit</button></a>
  
                                  <a data-toggle="modal" data-target="#modal_single_del{{ $y->id }}"  class="btn btn-danger">Delete</a>
                            ...
                            <div class="modal" id="modal_single_del{{ $y->id }}" tabindex="-1" role="dialog">
