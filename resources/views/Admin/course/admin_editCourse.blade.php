                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/update/course') }}" method="POST">
                                        @csrf
                                        @method('post')
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <br>
                                            <input type="text" class="form-control" name="course_name" value="{{ $data->course_name }}" id="exampleInputName" placeholder="Course Name">
                                           
                                        </div>
                                        <div class="form-group" >
                                          <label for="exampleInputCode"> Course Code</label>
                                          <br>
                                          <input type="text" class="form-control" name="course_code" value="{{ $data->course_code }}" id="exampleInputCode" placeholder="Course Code">
                                    ...
                                    <div class="form-group" >
                                      ...
                                      <br>
                                      <input type="number" class="form-control" name="course_score" value="{{ $data->course_score }}" id="exampleInputCode" placeholder="Course Code">
