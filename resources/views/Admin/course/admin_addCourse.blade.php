                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/store/course') }}" method="POST">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <br>
                                            <input type="text" class="form-control" name="course_name" value="{{ old('course_name') }}" id="exampleInputName" placeholder="Course Name">
                                           
                                        </div>
                                        <div class="form-group" >
                                          <label for="exampleInputCode"> Course Code</label>
                                          <br>
                                          <input type="text" class="form-control" name="course_code" value="{{ old('course_code') }}" id="exampleInputCode" placeholder="Course Code">
                                         
                                      </div>
    
                                
                                    <div class="form-group" >
                                      <label for="exampleInputCode"> Course Score</label>
                                      <br>
                                      <input type="number" class="form-control" name="course_score" value="{{ old('course_score') }}" id="exampleInputCode" placeholder="Course Code">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleSelectSlevel">Sub Level</label>
                                              <select class="form-control" name= sublev_id id="exampleSelectSlevel">
                                               @foreach ($sublev1 as $sublev)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="term_id" id="exampleInputElevel">
                                            @foreach ($ter as$termm)
                                                 <option value="{{ $termm->id }}">{{ $termm->term_name }}</option>
                                            @endforeach
