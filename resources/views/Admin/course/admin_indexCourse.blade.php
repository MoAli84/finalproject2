                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                              ...
                              <p class="card-description" style="margin: 20px;">
                                <a href="{{ url('admin/create/course') }}" > <button type="button" class="btn btn-primary"> Add Course</button></a>
                              </p>
                                <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($data as $info)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $info->course_score }}</td>
                                                            <td>{{ $info->level }}</td>
                                                            <td>{{ $info->sublev }}</td>
                                                            <td>{{ $info->term_name }}</td>
                                                            <td>

                                                                <a href='{{ url('admin/edit/course/'. $info->id ) }}' class='btn btn-primary m-r-1em'>Edit</a>
                                                                {{-- **********************************POP UP of Delete..*************************************************** --}}
                                                                <a data-toggle="modal"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">Delete...!<br>
                                                                        ...
                                                                        {{$info->course_name ." its code  : ". $info->course_code }}</div>
