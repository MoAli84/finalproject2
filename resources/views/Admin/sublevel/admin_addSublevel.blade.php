                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/store/sublevel') }}" method="POST">
                                      @csrf
                                      @method('post')
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="form-control" name="level_id" id="exampleSelectStage" style="width: 50%;">
                                           @foreach ($lev as $leve )
                                               <option value="{{ $leve->id }}">{{ $leve->level }}</option>
                                           @endforeach 
                                        </select>
                                      </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality" name="sublev" value="{{ old('sublev') }}"
