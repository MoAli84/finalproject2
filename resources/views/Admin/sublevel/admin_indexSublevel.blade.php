            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card col-md-8 grid-margin">
                <p class="card-description" style="margin: 20px;">
                    <a href="{{ url('admin/create/sublevel') }}" > <button type="button" class="btn btn-primary"> Add Sub_Level</button></a>
                  </p>
                        ...
                        @foreach ($data as $sub)
                           <td>{{ $sub->id }} </td>
                            ...
                            <td>
                                ...
                                <a href="{{ url('admin/edit/sublevel/'. $sub->id ) }}"> <button type="button" class="btn btn-primary"  style="margin-right: 10px;"> Edit</button></a>

                                <a data-toggle="modal" data-target="#modal_single_del{{ $sub->id }}"  class="btn btn-danger">Delete</a>
                          ...
                          <div class="modal" id="modal_single_del{{ $sub->id }}" tabindex="-1" role="dialog">
