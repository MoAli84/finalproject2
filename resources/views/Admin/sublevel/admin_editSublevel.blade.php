                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/update/sublevel') }}" method="POST">
                                      @csrf
                                      @method('post')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="level_id" style="width: 50%;">
                                                @foreach ($le as $info)
                                                    <option value="{{ $info->id }}"
                                                        @if ($data->level_id == $info->id) selected @endif>
                                                        {{ $info->level }}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality" name="sublev" value="{{$data->sublev}}"
